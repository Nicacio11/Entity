...
CREATE TABLE [PostTag] (
    ...
    CONSTRAINT [FK_PostRole_PostId] FOREIGN KEY ([PostId]) REFERENCES [Tags] ([Id]) ON DELETE CASCADE,
...
VALUES (N'20220627142121_InitialMigration', N'5.0.9');
GO
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20220627143000_AddGitHubToUser', N'5.0.9');
GO
